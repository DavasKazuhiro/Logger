...
#ifndef _TAO_IDL____IDL_LOGGERC_000PXX_H_
#define _TAO_IDL____IDL_LOGGERC_000PXX_H_
...
#if TAO_MAJOR_VERSION != 4 || TAO_MINOR_VERSION != 0 || TAO_MICRO_VERSION != 4
...
class  NenhumEventoCadastrado : public ::CORBA::UserException
{
public:

  NenhumEventoCadastrado ();
  NenhumEventoCadastrado (const NenhumEventoCadastrado &);
  ~NenhumEventoCadastrado () = default;

  NenhumEventoCadastrado &operator= (const NenhumEventoCadastrado &);

  static void _tao_any_destructor (void *);

  static NenhumEventoCadastrado *_downcast (::CORBA::Exception *);
  static const NenhumEventoCadastrado *_downcast (::CORBA::Exception const *);
...
extern  ::CORBA::TypeCode_ptr const _tc_NenhumEventoCadastrado;
// TAO_IDL - Generated from
...
namespace CORBA {
 ...
 void operator<<= (::CORBA::Any &, const NenhumEventoCadastrado &); // copying version
 void operator<<= (::CORBA::Any &, NenhumEventoCadastrado*); // noncopying version
 ::CORBA::Boolean operator>>= (const ::CORBA::Any &, const NenhumEventoCadastrado *&);
}
TAO_END_VERSIONED_NAMESPACE_DECL
...
TAO_BEGIN_VERSIONED_NAMESPACE_DECL
 ...
 ::CORBA::Boolean operator<< (TAO_OutputCDR &, const NenhumEventoCadastrado &);
 ::CORBA::Boolean operator>> (TAO_InputCDR &, NenhumEventoCadastrado &);
